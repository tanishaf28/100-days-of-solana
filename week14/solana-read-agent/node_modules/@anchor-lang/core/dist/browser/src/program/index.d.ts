...
import { AccountNamespace, IdlEvents, InstructionNamespace, MethodsNamespace, RpcNamespace, SimulateNamespace, TransactionNamespace, ViewNamespace } from "./namespace/index.js";
...
export declare class Program<IDL extends Idl = Idl> {
     ...
     */
    constructor(idl: any, provider?: Provider, coder?: Coder, getCustomResolver?: (instruction: IdlInstruction) => CustomAccountResolver<IDL> | undefined);
    /**
     ...
     * @param provider  The network and wallet context.
     */
    static fetchIdl<IDL extends Idl = Idl>(programAddress: Address, provider?: Provider): Promise<IDL | null>;
    /**
     ...
     *                  program logs.
     */
    addEventListener<E extends keyof IdlEvents<IDL>>(eventName: E & string, callback: (event: IdlEvents<IDL>[E], slot: number, signature: string) => void, commitment?: Commitment): number;
    /**
