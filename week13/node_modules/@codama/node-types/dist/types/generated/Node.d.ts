...
export type Node = AccountNode | ConstantNode | DefinedTypeNode | ErrorNode | EventNode | InstructionAccountNode | InstructionArgumentNode | InstructionByteDeltaNode | InstructionNode | InstructionRemainingAccountsNode | InstructionStatusNode | PdaNode | PluginNode | ProgramNode | ProvidedNode | RegisteredContextualValueNode | RegisteredCountNode | RegisteredDiscriminatorNode | RegisteredDisplayNode | RegisteredLinkNode | RegisteredPdaSeedNode | RegisteredTypeNode | RegisteredValueNode | RootNode;
export type GetNodeFromKind<TKind extends NodeKind> = Extract<Node, {
    kind: TKind;
}>;
