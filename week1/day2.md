# Day 2: Building a Persistent Wallet

## Steps

1. I created a new file called `persistent-wallet.mjs`:
...
The first run creates a new wallet and saves it to `wallet.json`. Every subsequent run loads the same wallet. I fund it through the faucet once and the balance persists across runs.
