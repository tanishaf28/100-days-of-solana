 ...
 */
export type NestedTypeNode<TType extends TypeNode> = FixedSizeTypeNode<NestedTypeNode<TType>> | HiddenPrefixTypeNode<NestedTypeNode<TType>> | HiddenSuffixTypeNode<NestedTypeNode<TType>> | PostOffsetTypeNode<NestedTypeNode<TType>> | PreOffsetTypeNode<NestedTypeNode<TType>> | SentinelTypeNode<NestedTypeNode<TType>> | SizePrefixTypeNode<NestedTypeNode<TType>> | TType;
